...
export function KalkulacijaRobe() {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await fetch(`${API_URL}/api/pregledi/kalkulacija-robe`, {
        credentials: "include",
      });
      ...
      if (!response.ok || !payload?.success) {
        throw new Error(
          payload?.message || "Greška pri učitavanju kalkulacije robe.",
        );
      }
